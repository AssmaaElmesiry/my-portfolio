<template>
    <section class="bg-bgsection">
        <div class="container mx-auto px-4">
            ...
            <div class="flex xl:justify-between items-center sm:flex-wrap sm:flex-row flex-col mt-24">
                <div class="mb-6 sm:w-1/6 w-full">
                    <div class="flex justify-center flex-col">
                        <fa class="text-html text-6xl" :icon="['fab','html5']" />
                        <h2 class="text-white text-center m-3 text-gray"> Html </h2>
                ...
                <div class="mb-6 sm:w-1/6 w-full">
                    <div class="flex justify-center flex-col">
                        ...
                        <h2 class="text-white text-center m-3 text-gray"> Css </h2>
                ...
                <div class="mb-6 sm:w-1/6 w-full">
                    <div class="flex justify-center flex-col">
                        ...
                        <h2 class="text-white text-center m-3 text-gray">Sass</h2>
                ...
                <div class="mb-6 sm:w-1/6 w-full">
                    <div class="flex justify-center flex-col">
                        ...
                        <h2 class="text-white text-center m-3 text-gray">Js</h2>
                ...
                <div class="mb-6 sm:w-1/6 w-full">
                    <div class="flex justify-center flex-col">
                        ...
                        <h2 class="text-white text-center m-3 text-gray">Bootstrap</h2>
                        <k-progress :percent="100" color="#9466dc" :show-text="false"></k-progress>
                    </div>
                </div>
                <div class="mb-6 sm:w-1/6 w-full">
                    <div class="flex justify-center flex-col">
                        <div class="w-full h-14 flex justify-center items-center"><img class="w-11" :src="tailwind" /></div>
                        <h2 class="text-white text-center m-3 text-gray">TailwindCss</h2>
                ...
                <div class="mb-6 sm:w-1/6 w-full">
                    <div class="flex justify-center flex-col">
                        ...
                        <h2 class="text-white text-center m-3 text-gray">vuejs</h2>
